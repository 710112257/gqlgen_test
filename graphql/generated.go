...
type QueryResolver interface {
	...
	People(ctx context.Context) (*People, error)
...
func (ec *executionContext) _Query_article(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNArticle2ᚖgithubᚗcomᚋ710112257ᚋgqlgen_testᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_people(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*People)
	fc.Result = res
	return ec.marshalNPeople2ᚖgithubᚗcomᚋ710112257ᚋgqlgen_testᚋgraphqlᚐPeople(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2githubᚗcomᚋ710112257ᚋgqlgen_testᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v model.Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚖgithubᚗcomᚋ710112257ᚋgqlgen_testᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNPeople2githubᚗcomᚋ710112257ᚋgqlgen_testᚋgraphqlᚐPeople(ctx context.Context, sel ast.SelectionSet, v People) graphql.Marshaler {
	return ec._People(ctx, sel, &v)
}

func (ec *executionContext) marshalNPeople2ᚖgithubᚗcomᚋ710112257ᚋgqlgen_testᚋgraphqlᚐPeople(ctx context.Context, sel ast.SelectionSet, v *People) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
