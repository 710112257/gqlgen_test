...
type QueryResolver interface {
	Article(ctx context.Context) (*Article, error)
...
var sources = []*ast.Source{
	{Name: "graph/query.graphql", Input: `
type Query {
  article: Article!
  hello: String!
...
func (ec *executionContext) _Article_text(ctx context.Context, field graphql.CollectedField, obj *Article) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
...
func (ec *executionContext) _Query_article(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.(*Article)
	fc.Result = res
	return ec.marshalNArticle2ᚖgqlgen_testᚋgraphqlᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2gqlgen_testᚋgraphqlᚐArticle(ctx context.Context, sel ast.SelectionSet, v Article) graphql.Marshaler {
	return ec._Article(ctx, sel, &v)
}

func (ec *executionContext) marshalNArticle2ᚖgqlgen_testᚋgraphqlᚐArticle(ctx context.Context, sel ast.SelectionSet, v *Article) graphql.Marshaler {
	if v == nil {
